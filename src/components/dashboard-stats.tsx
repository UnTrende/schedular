  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 mb-8">
      ...
      <motion.div
        ...
        className="group relative overflow-hidden bg-white dark:bg-slate-900 rounded-2xl p-6 transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_8px_30px_rgba(0,0,0,0.04)] shadow-[0_2px_10px_rgba(0,0,0,0.03)] ring-1 ring-slate-200 dark:ring-slate-800"
      >
      ...
      <motion.div
        ...
        className="group relative overflow-hidden bg-white dark:bg-slate-900 rounded-2xl p-6 transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_8px_30px_rgba(0,0,0,0.04)] shadow-[0_2px_10px_rgba(0,0,0,0.03)] ring-1 ring-slate-200 dark:ring-slate-800 sm:col-span-2 lg:col-span-1"
      >
        <div className="absolute top-0 right-0 p-4 opacity-50 group-hover:opacity-100 transition-opacity">
